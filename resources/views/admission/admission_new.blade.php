                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body tw-flex tw-flex-col">
                                ...
                                <input class="input-field" type="text" name="last_name" id="lastname"
                                    placeholder="Enter last name" required />
                                <label class="input-label" for="firstname"> First Name </label>
                                <input class="input-field" type="text" name="first_name" id="firstname"
                                ...
                                <input type="number" name="cell_no" id="cellno" class="input-field" maxlength="11"
