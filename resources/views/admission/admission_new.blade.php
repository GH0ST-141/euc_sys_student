    ...
    <main>
      <div id="content">
        ...
        <form id="admission-form" action="">
          ...
          <label class="input-label" for="suffix"> Address </label
          ><input
            class="input-field"
            type="text"
            name=""
          ...
          ><input
            ...
            name=""
            id="birth-place"
            placeholder="Enter full birth address"
            required
          />
          ...
          <input type="number" name="" id="cellno" class="input-field" maxlength="11" pattern="[0-9]{11}" placeholder="Enter cellphone number" required>

          <label class="input-label" for="email">Email</label>
          <input type="email" name="" id="email" class="input-field" placeholder="Enter Email" required>
