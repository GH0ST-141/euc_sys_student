<div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
        ...
        <div class="accordion-body tw-flex tw-flex-col">
            ...
            <input class="input-field" type="text" name="last_name" id="lastname" placeholder="Enter last name"
                required />
            ...
            <input class="input-field" type="text" name="street" id="street" placeholder="Enter street"
                required />

            <label class="input-label" for="brgy"> Barangay </label>
            <input class="input-field" type="text" name="brgy" id="brgy" placeholder="Enter barangay"
                required />

            <label class="input-label" for="municipality"> Municipality/Town </label>
            <input class="input-field" type="text" name="municipality" id="municipality"
                placeholder="Enter municipality" required />

            <label class="input-label" for="province"> Province/City </label>
            <input class="input-field" type="text" name="province" id="province"
            ...
            <input class="input-field" type="text" name="birth_place" id="birth-place"
