...
<div class="flex flex-col p-4 ">
    ...
    <input value="{{ old('last_name') }}" class="input-field" type="text" name="last_name" id="lastname" placeholder="Enter last name" required />
    <x-input-error :messages="$errors->get('last_name')" class="mt-2" />

    <label class="input-label" for="firstname"> First Name </label>
    <input value="{{ old('first_name') }}" class="input-field" type="text" name="first_name" id="firstname" placeholder="Enter first name"
        required />
    ...
    <input value="{{ old('birth_date') }}" class="input-field" type="date" name="birth_date" id="birthdate" required />

    <label class="input-label" for="birth-place"> Birth Place </label>
    <input value="{{ old('birth_place') }}" class="input-field" type="text" name="birth_place" id="birth-place" placeholder="Enter full birth address"
        required />
    ...
    <input value="{{ old('cell_no') }}" type="number" name="cell_no" id="cellno" class="input-field" maxlength="11" pattern="[0-9]{11}"
        placeholder="Enter cellphone number" required>

    <label class="input-label" for="email">Email</label>
    <input value="{{ old('email') }}" type="email" name="email" id="email" class="input-field" placeholder="Enter Email" required>
</div>
