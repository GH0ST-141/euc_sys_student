<div class="flex flex-col p-4 ">
    ...
    <input value="{{ old('elem_grad_yr') }}" type="number" name="elem_grad_yr" id="elem-grad-yr" class="yearpicker form-control input-field-d" value="" />
    ...
    <input value="{{ old('jhs_grad_yr') }}" type="number" name="jhs_grad_yr" id="jhs-grad-yr" class="yearpicker form-control input-field-d" value="" />
    ...
    <input value="{{ old('shs_grad_yr') }}" type="number" name="shs_grad_yr" id="shs-grad-yr" class="yearpicker form-control input-field-d" value="" />
</div>
