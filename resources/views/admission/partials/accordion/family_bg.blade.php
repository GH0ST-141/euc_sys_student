<div class="flex flex-col p-4 ">
    ...
    <input value="{{ old('guardian_address') }}" class="input-field" type="number" name="guardian_cell_no" id="guardian-cellno" placeholder="Enter your guardian's contact number" required />
</div>
