...
class StudentInfoNewController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // REVIEW: This will redirect the user to the <landing> page when this error
            // about the user_id (id of current user) is already present in the student_info table
            // meaning they have filled the admission form already
            return to_route('landing')->with('error', 'You have already filled the admission form!');
        }
